<%@ Page Title="Customers" Language="C#" MasterPageFile="~/admin/AdminSidebar.master" AutoEventWireup="true" CodeBehind="ViewCustomers.aspx.cs" Inherits="InsuranceManagement.admin.ViewCustomers" %>
                        ...
                        <ItemTemplate>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><%#Eval("pincode") %></td>
                                    <td>
                                        <a target="_blank" href="/admin/ViewCustomerInfo?custId=<%#Eval("id") %>">View</a>
                                    </td>
                                    <td>
